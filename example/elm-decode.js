...
*/
  ...
  var $author$project$Example$User$User = F2(function (name, age) {
  ...
  var $author$project$Example$User$decoder = A3(
    $elm$json$Json$Decode$map2,
    $author$project$Example$User$User,
    A2($elm$json$Json$Decode$field, "name", $elm$json$Json$Decode$string),
    A2($elm$json$Json$Decode$field, "age", $elm$json$Json$Decode$int)
  );
  var $elm$json$Json$Decode$value = _Json_decodeValue;
  var $author$project$DecodeRunner$moduleInput = _Platform_incomingPort(
    "moduleInput",
  ...
  var $author$project$DecodeRunner$sendToJS = _Platform_outgoingPort(
    "sendToJS",
  ...
  var $author$project$DecodeRunner$main = $elm$core$Platform$worker({
    init: function (_v0) {
      return _Utils_Tuple2(_Utils_Tuple0, $elm$core$Platform$Cmd$none);
    },
    subscriptions: function (_v1) {
      return $author$project$DecodeRunner$moduleInput(function (json) {
        return json;
      });
    },
    update: F2(function (json, _v2) {
      var _v3 = A2(
        $elm$json$Json$Decode$decodeValue,
        $author$project$Example$User$decoder,
        json
      );
      if (_v3.$ === "Ok") {
        var value = _v3.a;
        return _Utils_Tuple2(
          _Utils_Tuple0,
          $author$project$DecodeRunner$sendToJS(
            $elm$json$Json$Encode$string(
              "Success: " + $elm$core$Debug$toString(value)
            )
          )
        );
      } else {
  ...
  _Platform_export({
    DecodeRunner: {
      init: $author$project$DecodeRunner$main(
